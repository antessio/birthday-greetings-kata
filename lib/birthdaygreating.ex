defmodule Birthdaygreating do
  ...
  defmodule Message do
    ...
    defstruct [:subject, :body, :recipient]
  end
  ...
  @type friend_fetcher :: (Date.t() -> [Friend.t()])

  @spec send(Date.t, friend_fetcher()) :: [Message.t()]
  def send(_date, _friend_fetcher) do
    []
  end
end
